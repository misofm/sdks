...
export const ReleaseCoverArtSetEvent = new MoveStruct({ name: `${$moduleName}::ReleaseCoverArtSetEvent`, fields: {
        ...
        previous_still_blob_id: bcs.u256(),
        previous_still_is_encrypted: bcs.bool(),
        previous_still_sealed_dek_length: bcs.u64(),
        previous_still_sealed_dek_digest: bcs.vector(bcs.u8()),
        previous_has_animated: bcs.bool(),
        previous_animated_blob_id: bcs.u256(),
        previous_animated_is_encrypted: bcs.bool(),
        previous_animated_sealed_dek_length: bcs.u64(),
        previous_animated_sealed_dek_digest: bcs.vector(bcs.u8()),
        current_present: bcs.bool(),
        current_still_blob_id: bcs.u256(),
        current_still_is_encrypted: bcs.bool(),
        current_still_sealed_dek_length: bcs.u64(),
        current_still_sealed_dek_digest: bcs.vector(bcs.u8()),
        current_has_animated: bcs.bool(),
        current_animated_blob_id: bcs.u256(),
...
export const ReleaseCoverArtUnsetEvent = new MoveStruct({ name: `${$moduleName}::ReleaseCoverArtUnsetEvent`, fields: {
        release_id: bcs.Address,
        admin_cap_id: bcs.Address,
        track_count: bcs.u64(),
        field_existed_before: bcs.bool(),
...
export const ReleaseTrackCoverArtSetEvent = new MoveStruct({ name: `${$moduleName}::ReleaseTrackCoverArtSetEvent`, fields: {
        release_id: bcs.Address,
        admin_cap_id: bcs.Address,
        track_count: bcs.u64(),
        field_existed_before: bcs.bool(),
